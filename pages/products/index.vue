<template>
  <div class="container mx-auto flex flex-col md:flex-row">
    <img
        class="md:w-1/2 w-full aspect-square object-cover h-full md:sticky top-0"
    ...
    <div class="p-8 ">
      ...
      <div tabindex="0" class="collapse collapse-arrow mb-32 border-y">
      ...
      <div
        ...
        <button class="px-6 py-3 rounded-full border border-1 border-gray-300 focus:scale-[0.94] focus:border-primary">
          Add to cart
        </button>
      </div>
    </div>
